...
############################
# function to find cluster data with output hard coded for Janani's sticker system
...
# Edited: 04/23/2016 Connor-- only clusters with more than 2 CI in the list
############################
